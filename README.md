...
- دقت کنید که مثال بالا بصورت داینامیک نوع پرداخت را عوض می کند (شما می توانید با توجه به نیاز خود از یکی یا  هر دو حالت پرداخت به صورت داینامیک استفاده کنید)
