...
<p dir="rtl">
در این اپلیکیشن از کتابخانه AlsatIPGAndroid برای پرداخت صورت حساب به صورت اینترنتی استفاده شده است که با دو روش پیاده سازی اینترفیس یا callback  قابل پیاده سازی است . 
<br>
